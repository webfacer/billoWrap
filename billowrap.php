...
class billoWrap {
    ...
    {
	return $this->setRequestData(self::RESOURCE_INVOICES);
    }
    ...
    {
	return $this->setRequestData(self::RESOURCE_INVOICES, $data, 'post');
    }
    ...
    {
	return $this->setRequestData(sprintf(self::RESOURCE_INVOICE, $id), $data, 'put');
    }
